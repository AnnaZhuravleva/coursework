...
def vw(word):
    cats = ['родственник', 'свойство', 'деятель', 'действие', 'качество', 'должность', 'событие', 'свойство',
            'организация', 'предмет', 'человек', 'глава', 'руководитель', 'коллектив', 'сотрудник',
            'учреждение', 'группа', 'часть', 'отдел', 'документ', 'устройство', 'способность', 'характеристика',
            'двигаться', 'перемещаться', 'существовать', 'исполнитель',
            'организация', 'устройство', 'создание', 'изменение']
    rel_dict = {}
    for cat in cats:
        try:
